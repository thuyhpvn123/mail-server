...
// // addInlineImage embeds an image inline using CID
...
// 	// buffer := make([]byte, 3*1024) // 3KB chunk size
// 	// encoder := quotedprintable.NewWriter(imageWriter)
// 	// defer encoder.Close()
...
// 	// return nil
// 	encoder := base64.NewEncoder(base64.StdEncoding, imageWriter)
// 	defer encoder.Close()
